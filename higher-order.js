...
//Code Here
let totalPopulation = populations.reduce(function(total, e, i, arr) {
  return total + e;
});
...
let orderTotals = orders.map(function(e, i, arr) {
  return e.price * (1 + e.tax);
});

// let orderTotals = 0;
// orders.forEach(function(e, i, arr) {
//   orderTotals += e.price * (1 + e.tax);
// });
...
//       return e.owner === "Bob";
//     })
//     .reduce(function (total, purchase, index, arr) {
//       return total + purchase.price;

//     }, 0)
// )

// let bobsPurchases = purchases
//   .filter(function (e, i, arr) {
//     return e.owner === "Bob";
//   });

// let bobsPurchasesTotal = bobsPurchases.reduce(function (total, purchase, index, arr) {
//   return total + purchase.price;
